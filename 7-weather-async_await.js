import"./assets/styles-B_vy0JBt.js";import{i as c}from"./assets/vendor-BpUGnplp.js";async function u(e,t){const a=await fetch(`https://api.weatherapi.com/v1/forecast.json?key=09a333eec31b44aab6a163037252406&q=${e}&days=${t}&lang=ru`);if(!a.ok)throw l("Sorry, there is no information matching your search query. Try again!","pink"),new Error(`Ошибка ${a.status}: ${a.statusText}`);return a.json()}function l(e,t){return c.show({message:e,messageColor:"#ff0000",backgroundColor:t,icon:"	fa fa-ban",iconColor:"#8b0000",position:"topRight"})}function h(e){return e.map(({date:t,day:{avgtemp_c:r,condition:{icon:o,text:a}}})=>`<li class="weather-item">
...
//# sourceMappingURL=7-weather-async_await.js.map
