import"./assets/styles-B_vy0JBt.js";import{i as s}from"./assets/vendor-BpUGnplp.js";function u(e,t){return fetch(`https://api.weatherapi.com/v1/forecast.json?key=09a333eec31b44aab6a163037252406&q=${e}&days=${t}&lang=ru`).then(r=>{if(!r.ok)throw l("Sorry, there is no information matching your search query. Try again!","pink"),new Error(r.statusText);return r.json()})}function l(e,t){return s.show({message:e,messageColor:"#ff0000",backgroundColor:t,icon:"	fa fa-ban",iconColor:"#8b0000",position:"topRight"})}function h(e){return e.map(({date:t,day:{avgtemp_c:a,condition:{icon:o,text:r}}})=>`<li class="weather-item">
...
//# sourceMappingURL=3-weather-then_catch.js.map
